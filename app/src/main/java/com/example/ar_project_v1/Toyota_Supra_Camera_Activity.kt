...
class Toyota_Supra_Camera_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_toyota_supra_camera)
        ...
        modelNode = ArModelNode().apply {
            loadModelGlbAsync(glbFileLocation = "models/toyota_supra_3d_model_free.glb") {
