...
class Toyota_Corolla_Camera_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_toyota_corolla_camera)
        ...
        modelNode = ArModelNode().apply {
            loadModelGlbAsync(glbFileLocation = "models/toyota-corolla-e170-2017.glb") {
